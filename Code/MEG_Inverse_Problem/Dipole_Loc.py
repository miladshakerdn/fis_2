...
# نام فایل به چیزی که شما در اختیار دارید تغییر داده شد
...
theta = np.deg2rad(45)
phi = np.deg2rad(45)
# The radius is already defined as 0.07
...
#TODO: Define the orientation vector for the new dipole (for visualization purposes)
q_0 = np.array([0, 0, 1])
