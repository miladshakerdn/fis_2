...
# Load the FULL 33x315 lead field matrix
data2 = np.load("../Dataset/MEG/MEG_Lead_Field_1.npz")

# ----------------------- Step 2: Define and Generate the Measurement Vector (B_r) -----------------------
...
# Extract the full lead field matrix G
G = data2['G']

# --- THIS IS THE KEY CORRECTION ---
# We create the measurement vector B_r by simulating the signal from the true source.
# The true source is the 105th dipole, which corresponds to the last 3 columns of G.
G_true_source = G[:, -3:] # Shape will be (33, 3)
B_r = G_true_source @ q_0   # Shape will be (33,)
...
plt.title('MEG Estimated Current Source Magnitude', c='r')
...
ax.plot_surface(x_hemisphere, y_hemisphere, z_hemisphere, color='b', alpha=0.05)
