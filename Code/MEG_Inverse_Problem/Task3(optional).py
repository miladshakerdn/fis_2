...
# Create the measurement vector B_r by simulating the signal from the true source.
# The true source is the 105th dipole, which corresponds to the last 3 columns of G.
G_true_source = G[:, -3:] # Shape: (33, 3)
B_r = G_true_source @ q_0   # Shape: (33,)

# ----------------------- Step 3: Calculate the MNE Solution -----------------------
# Recalculate the results from Task 2 using the correct B_r
q = pinv(G) @ B_r
q1 = q.reshape(105, 3)
